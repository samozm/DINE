...
estimate_D <- function(r0, masterZ, E, masterV, MAP, n, k, t) {
    .Call(`_DCENt_estimate_D`, r0, masterZ, E, masterV, MAP, n, k, t)
}

estimate_E <- function(r0, masterZ, D, masterV, MAP, n, k, t) {
    .Call(`_DCENt_estimate_E`, r0, masterZ, D, masterV, MAP, n, k, t)
}

estimate_all <- function(X, y, masterZ, MAP, n, k, t, max_itr = 250L, convergence_cutoff = 0.00005, REML = FALSE, n_fold = 5L, timings = FALSE, verbose = FALSE, seed = 1121L) {
    .Call(`_DCENt_estimate_all`, X, y, masterZ, MAP, n, k, t, max_itr, convergence_cutoff, REML, n_fold, timings, verbose, seed)
}
...
covCalc <- function(X, MAP) {
    .Call(`_DCENt_covCalc`, X, MAP)
}

Z_assemble <- function(masterZ, MAP, i, k, t, kt) {
    .Call(`_DCENt_Z_assemble`, masterZ, MAP, i, k, t, kt)
}

calc_ZDZ_plus_E_list <- function(masterZt, D, E, MAP, n, k, t) {
    .Call(`_DCENt_calc_ZDZ_plus_E_list`, masterZt, D, E, MAP, n, k, t)
}

calc_ZDZ_plus_E <- function(masterZt, D, E, MAP, n, k, t, nkt) {
    .Call(`_DCENt_calc_ZDZ_plus_E`, masterZt, D, E, MAP, n, k, t, nkt)
}

check_openmp <- function() {
    .Call(`_DCENt_check_openmp`)
}
